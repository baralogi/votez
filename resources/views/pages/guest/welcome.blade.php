    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    <a href={{ route('home.vacancy.index') }}
                        class="text-sm text-gray-700 dark:text-gray-500 underline">Lowongan
                        Pekerjaan</a>
                    <a href="{{ route('login') }}"
                        class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Masuk</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Daftar</a>
                    @endif
